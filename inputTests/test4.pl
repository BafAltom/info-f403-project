# Teste 4 : Teste complet
# Reprend tous les testes précédents
# Vérifie donc les expressions, fonctions, conditions et retours
# Le résultat de ce code est montré dans l'annexe du rapport, Figure 16
